...
import json
from src.algos.path_finder import PathFinder
...
def main():
    ...
    maps_itinary = "/".join(["'{},{}'".format(booking.address.lat, booking.address.lng) for booking in optimal_path])
    print("https://www.google.com/maps/dir/{}?entry=ttu".format(maps_itinary))
